        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Available_Program_WashingMachines_WashingMachineId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Maciej", "Mesjasz", "+48794287703" });

            migrationBuilder.InsertData(
                table: "Program",
                columns: new[] { "ProgramId", "DurationMinutes", "Name", "TemperatureCelcius" },
                values: new object[,]
                {
                    { 1, 69, "Quickie", 30 },
                    { 2, 143, "CottonDestroyer", 90 },
                    { 3, 90, "Synthetic", 5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 32.12m, "APBD1111/S123/15" },
                    { 2, 55.23m, "APBD1112/S123/24" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2025, 6, 8, 10, 0, 0, 0, DateTimeKind.Unspecified), 5 },
                    { 2, 1, new DateTime(2025, 6, 8, 11, 0, 0, 0, DateTimeKind.Unspecified), null }
                });
